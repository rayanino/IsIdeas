...
| I-002 | Curriculum Architect | dossier | challenge | visible | sequencing and prerequisite discipline | false authority if system invents structures instead of consuming them | blocked_for_build | preserve the first external review, revise authority-loaded terminology, then obtain the next external validation response before any promotion |
