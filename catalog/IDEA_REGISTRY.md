...
| I-002 | Curriculum Architect | dossier | challenge | visible | sequencing and prerequisite discipline | false authority if system invents structures instead of consuming them | blocked_for_build | rerun the external gate against the updated validator-facing bundle, then decide whether the AI-review loop can end |
