...
| I-002 | Curriculum Architect | dossier | challenge | visible | sequencing and prerequisite discipline | false authority if system invents structures instead of consuming them | blocked_for_build | obtain and preserve the first external validation response to `ideas/curriculum-architect/RESEARCH.md` before any promotion |
