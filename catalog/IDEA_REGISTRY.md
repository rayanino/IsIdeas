...
| I-002 | Curriculum Architect | dossier | challenge | visible | sequencing and prerequisite discipline | false authority if system invents structures instead of consuming them | blocked_for_build | obtain the next external validation response against the revised packet, then reassess whether the idea strengthens, conditions, or stalls |
