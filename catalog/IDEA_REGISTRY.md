...
| I-002 | Curriculum Architect | dossier | challenge | visible | sequencing and prerequisite discipline | false authority if system invents structures instead of consuming them | blocked_for_build | prepare and send a focused scholar or curriculum-expert review on the two remaining structural tensions, then reassess whether the AI-review loop can end |
