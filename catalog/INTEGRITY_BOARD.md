...
| F-002 | medium | open | Seed portfolio still reflects workshop-era assumptions | 2026-03-30 | 2026-03-31 | Factory scope drift has been corrected, but the next frontier still needs deliberate selection and the bottleneck map still needs renewed pressure. | Select the next frontier idea deliberately after the hardening lands. |
